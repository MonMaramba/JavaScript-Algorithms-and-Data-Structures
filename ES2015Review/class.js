...
// The method to create new objects must be called constructor. The constructor method is never called as using the keyword new calls on the constructor method
...
class Student {
    ...
    calculateAverage() {
        let totals = this.scores.reduce((a, b) => { return (a + b) });
...
// according to mdn docs - The static keyword defines a static method for a class. Static methods are called without instantiating their class and cannot be called through a class instance. Static methods are often used to create utility functions for an application.
